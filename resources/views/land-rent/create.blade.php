@extends('layouts.app')
@section('title', 'إضافة إيجار أرض')
@section('content')

@include('partials.page-header', ['title' => 'إضافة دفعة إيجار أرض', 'icon' => 'fa-plus-circle'])

<div class="max-w-xl">
    <form action="{{ route('land-rent.store') }}" method="POST" class="card p-6 space-y-4">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="date" name="payment_date" value="{{ old('payment_date', today()->toDateString()) }}" class="input-field w-full px-3 py-2.5 text-sm">
            </div>
            <div>
